...
def generate_launch_description():
    ...
    Nodes.append(
        Node(
            ...
            parameters=[
                {'robot_name': 'robot_right'},
                {'robot_ip': '192.168.1.12'},
                {'robot_port': 6001},
                {'omni_command_topic': '/phantom2/state'},
                {'omni_button_event_topic': '/phantom2/button'}
            ]
        )
    )
    Nodes.append(Node(
    ...
    Nodes.append(Node(
            ...
            name='gripper_right',
            parameters=[
                {'device_path': '/dev/gripper_right'},
                {'subscribe_topic': '/phantom2/state'},
            ]
        ))
